<template>
  <div class="bg-cover bg-gradient-to-r from-rose-400 via-red-500 to-rose-500 ">
    <div>
        <!-- <h1>NGO</h1> -->
        <h2 class="text-5xl font-normal leading-normal mt-0 mb-2 text-white pb-14 font-bold"> Name:{{ngoDetails.name}}</h2>
    ...
    <div class="flex items-center border-b border-teal-500 py-2">
      ...
      <form @submit="changelist">
            ...
            <label>Country:</label>
            <input class="text-center appearance-none bg-transparent border-dotted border-2 border-white w-60 text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" placeholder="Country" v-model='newlist.country'/>
            <label>Founded:</label>
            <input class="text-center appearance-none bg-transparent border-dotted border-2 border-white w-60 text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" placeholder="founded" v-model='newlist.founded'/>
            <label>Email/contact:</label>
            <input class="text-center appearance-none bg-transparent border-dotted border-2 border-white w-60 text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" placeholder="email" v-model='newlist.email'/>
